...
import { VisLayerTypes, calculateYAxisPadding } from '../../../vis_augmenter/public';
...
export class VegaView extends VegaBaseView {
  async _initViewCustomizations() {
    ...
    if (showPointInTimeEvents) {
      ...
      const isEventVis = get(this, '_parser.visAugmenterConfig.isEventVis', true);
      ...
      if (inFlyout) {
        ...
        view.padding({
          ...
          left: leftValueAxisPadding && isEventVis ? yAxisPadding : 0,
          right: rightValueAxisPadding && isEventVis ? yAxisPadding : 0,
        });
      }
    }
